...
var start_width = 380; // 网页中间起始宽度
var start_heigth = 255; // 网页中间起始宽度
var enlargImgWidth = 700; // 放大后的图片大小
...
MagicZoom.prototype.showrect = function() {
    ...
    var body_width = document.body.clientWidth,
        width = document.getElementsByClassName("PInfoWrap")[0].offsetWidth;
    if (body_width > width) {
        var left = (body_width - width)/2 + 430 + "px";
    } else {
        var left = "430px"
    }
    this.bigImageCont.style.left = left;
};
...
MagicZoom.prototype.initBigContainer = function() {
    ...
    this.bigImage.width = enlargImgWidth;
...
MagicZoom.prototype.initZoom = function() {
    ...
    this.bigImageCont.style.left = start_width + this.smallImage.width + 15 + 'px';
    this.bigImageCont.style.top = start_heigth + 'px';
    switch (this.settings['position']) {
    case 'left':
        this.bigImageCont.style.left = '-' + (start_width + 15 + parseInt(this.bigImageCont.style.width)) + 'px';
        break;
    case 'bottom':
        this.bigImageCont.style.top = start_width + this.smallImage.height + 15 + 'px';
        this.bigImageCont.style.left = start_heigth + 'px';
        break;
    case 'top':
        this.bigImageCont.style.top = '-' + (start_width + 15 + parseInt(this.bigImageCont.style.height)) + 'px';
        this.bigImageCont.style.left = start_heigth + 'px';
        break;
    case 'custom':
        this.bigImageCont.style.left = start_width + 'px';
        this.bigImageCont.style.top = start_heigth + 'px';
        break;
    case 'inner':
        this.bigImageCont.style.left = start_width + 'px';
...
function MagicZoom_findZooms() {
    ...
    for (var i = 0; i < aels.length; i++) {
        if (/MagicZoom/.test(aels[i].className)) {
            ...
            document.body.appendChild(bigCont);
            var settings = {
