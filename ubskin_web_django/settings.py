"""
Django settings for ubskin_web_django project.
...
SECRET_KEY = 'ifkppneid14g$z)q29pa!gn6_usnzyqhcnq%v*)a)jd1x#bm8u'
...
WSGI_APPLICATION = 'ubskin_web_django.wsgi.application'
...
DATABASES = {
    'default' : {
        ...
        'NAME'     : os.getenv("DB_NAME", "ubskin_web"),
        'USER'     : os.getenv("DB_USER", "dev"),
        'PASSWORD' : os.getenv("DB_PASS", "devPass"),
        'HOST'     : os.getenv("DB_HOST", "ubs_db"),
